...
DEFINE FRAME frUpdate
     ...
     cbUpdateChannel AT Y 52 X 100 COLON-ALIGNED WIDGET-ID 200
...
ASSIGN XXTABVALXX = FRAME FRAME-S:MOVE-BEFORE-TAB-ITEM (FRAME FRAME-I:HANDLE)
       ...
       XXTABVALXX = FRAME frUpdate:MOVE-BEFORE-TAB-ITEM (FRAME FRAME-D:HANDLE)
/* END-ASSIGN-TABS */.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-19 fiCurrentVersion fiCurrentBuild btnCheckNow cbUpdateChannel 
      WITH FRAME frUpdate IN WINDOW C-Win.
