...
DEFINE FRAME FRAME-AB
     ...
     "Database Name in Title Bar" VIEW-AS TEXT
          SIZE-PIXELS 180 BY 13 AT Y 0 X 15 WIDGET-ID 180
...
DEFINE FRAME FRAME-Z
     ...
     "Data Browse Column Label Template" VIEW-AS TEXT
          SIZE-PIXELS 240 BY 13 AT Y 0 X 15 WIDGET-ID 180
...
DEFINE FRAME FRAME-V
     ...
     "Warning colors" VIEW-AS TEXT
          SIZE 23 BY .62 AT ROW 1 COL 4 WIDGET-ID 178
...
DEFINE FRAME FRAME-Y
     ...
     "Query Info colors" VIEW-AS TEXT
          SIZE 25 BY .62 AT ROW 1 COL 4 WIDGET-ID 178
...
DEFINE FRAME FRAME-T
     ...
     "Data Row colors" VIEW-AS TEXT
          SIZE 25 BY .62 AT ROW 1 COL 4 WIDGET-ID 180
...
DEFINE FRAME FRAME-AF
     ...
     "Nr of Records color" VIEW-AS TEXT
          SIZE 32 BY .62 AT ROW 1 COL 4 WIDGET-ID 180
...
DEFINE FRAME FRAME-A
     ...
     "Add Data Column For:" VIEW-AS TEXT
          SIZE-PIXELS 151 BY 13 AT Y 13 X 14 WIDGET-ID 62
