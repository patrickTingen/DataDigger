...
btnWhere btnQueries btnView fiTableDesc btnTools cbFavouriteGroup ~
btnTabTables ficWhere btnClear btnClearFieldFilter btnClearTableFilter ~
btnClipboard btnMoveBottom btnMoveDown btnMoveTop btnMoveUp btnReset ~
btnTableFilter btnTabFavourites btnTabFields btnTabIndexes btnFavourite ~
...
DEFINE BUTTON btnAddFavGroup  NO-FOCUS FLAT-BUTTON
     LABEL "+" 
     SIZE-PIXELS 20 BY 21 TOOLTIP "add favourites group".
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rctQuery rctEdit btnAddFavGroup fiTableFilter cbDatabaseFilter 
         ...
         btnClearIndexFilter brTables brFields brIndexes tgDebugMode btnWhere 
         btnQueries btnView fiTableDesc btnTools cbFavouriteGroup btnTabTables 
         ficWhere btnClear btnClearFieldFilter btnClearTableFilter btnClipboard 
